#!/usr/bin/env python3
"""
webhook_consumer.py - Simulates webhook_retry_queue consumer behavior.

Consumes from webhook_retry_queue and holds acks for a random duration
...
Usage:
    python3 webhook_consumer.py [--uri amqp://guest:guest@localhost:5672]
"""
...
QUEUE_NAME = "webhook_retry_queue"
MAX_HELD = 1000
MIN_ACK_DELAY = 60.0
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("webhook_consumer.log"),
    ],
)
